...
const LizConfig = {
  ...
  startersByMode: {
    code: [
      { icon: 'code',   title: 'Explicar código',  prompt: 'Explique este código pra mim: cole aqui' },
      { icon: 'bug',    title: 'Corrigir código',  prompt: 'Este código tem um problema, me ajuda a corrigir:' },
      { icon: 'prompt', title: 'Gerar comando CLI', prompt: 'Me ajude a montar um comando de terminal para:' },
      { icon: 'code',   title: 'Criar script',     prompt: 'Crie um script que faça o seguinte:' },
    ],
    design: [
      { icon: 'layers', title: 'Criar interface', prompt: 'Me ajude a criar uma interface moderna e limpa para:' },
      { icon: 'sparkle', title: 'Melhorar layout', prompt: 'Tenho este layout e quero melhorá-lo:' },
      { icon: 'layers', title: 'Criar componente', prompt: 'Crie um componente reutilizável para:' },
      { icon: 'sparkle', title: 'Gerar paleta',    prompt: 'Gere uma paleta de cores coerente para um projeto de:' },
    ],
    errors: [
      { icon: 'bug',     title: 'Colar erro',        prompt: 'Estou com este erro, me ajuda:' },
      { icon: 'prompt',  title: 'Analisar log',      prompt: 'Analise este log e me diga o problema:' },
      { icon: 'bug',     title: 'Corrigir bug',      prompt: 'Tenho um bug, me ajuda a corrigir:' },
      { icon: 'sparkle', title: 'Explicar problema', prompt: 'Me explica o que pode estar causando este problema:' },
    ],
    ideas: [
      { icon: 'bulb',   title: 'Gerar ideias',     prompt: 'Me dá ideias criativas para um projeto de:' },
      { icon: 'sparkle', title: 'Melhorar projeto', prompt: 'Tenho este projeto e quero melhorá-lo:' },
      { icon: 'bulb',   title: 'Criar nomes',      prompt: 'Me ajude a criar nomes para:' },
      { icon: 'prompt', title: 'Criar prompt',     prompt: 'Me ajude a criar um bom prompt para:' },
    ],
  },
  ...
  icons: {
    ...
    projects:  '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>',
